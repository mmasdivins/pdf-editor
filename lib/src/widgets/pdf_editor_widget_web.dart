...
import 'package:pdf_editor/utils/shims/dart_ui.dart' as ui;
...
class PdfEditorWidget extends StatefulWidget {
  ...
  @override
  _PdfEditorWidgetWebState createState() => _PdfEditorWidgetWebState();
}
...
class _PdfEditorWidgetWebState extends State<PdfEditorWidget> {
  ...
  void initSummernote() async {
    ...
    if ((Theme.of(widget.initBC).brightness == Brightness.dark ||
      ...
      darkCSS =
          '<link href=\"assets/packages/pdf_editor/assets/summernote-lite-dark.css\" rel=\"stylesheet\">';
    }
    var jsCallbacks = '';
    if (widget.callbacks != null) {
    ...
    """;
    var filePath =
        'packages/pdf_editor/assets/summernote-no-plugins.html';
    ...
    htmlString = htmlString
        ...
        .replaceFirst('"jquery.min.js"',
            '"assets/packages/pdf_editor/assets/jquery.min.js"')
        .replaceFirst('"summernote-lite.min.css"',
            '"assets/packages/pdf_editor/assets/summernote-lite.min.css"')
        .replaceFirst('"summernote-lite.min.js"',
            '"assets/packages/pdf_editor/assets/summernote-lite.min.js"');
